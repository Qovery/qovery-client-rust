...
**internal_network_monitoring** | Option<[**models::InternalNetworkMonitoring**](InternalNetworkMonitoring.md)> |  | [optional]
**alerting** | Option<[**models::AlertingConfig**](AlertingConfig.md)> |  | [optional]
