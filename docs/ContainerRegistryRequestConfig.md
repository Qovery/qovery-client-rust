...
**workload_identity_provider_resource** | Option<**String**> | Required if kind is `GCP_ARTIFACT_REGISTRY` and gcp_credentials_type is `workload_identity_federation` | [optional]
