...
**build_timeout_max_sec** | Option<**i32**> |  | [optional]
...
**network_ingress_proxy_buffering** | Option<**String**> | Allows to enable or disable nginx `proxy-request-buffering` | [optional]
...
**network_ingress_basic_auth_env_var** | Option<**String**> | Set the name of an environment variable to use as a basic authentication (`login:crypted_password`) from `htpasswd` command.  | [optional]
