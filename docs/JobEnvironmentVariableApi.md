...
> models::EnvironmentVariable create_job_environment_variable(job_id, environment_variable_request)
...
> models::EnvironmentVariable create_job_environment_variable_alias(job_id, environment_variable_id, key)
...
> models::EnvironmentVariable create_job_environment_variable_override(job_id, environment_variable_id, value)
...
> models::EnvironmentVariable edit_job_environment_variable(job_id, environment_variable_id, environment_variable_edit_request)
...
> models::VariableImport import_job_environment_variable(job_id, variable_import_request)
Import variables
...
> models::EnvironmentVariableResponseList list_job_environment_variable(job_id)
