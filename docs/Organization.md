...
**owner** | Option<**uuid::Uuid**> | uuid of the user owning the organization | [optional]
...
**organization_plan** | Option<[**models::OrganizationAllOfOrganizationPlan**](OrganizationAllOfOrganizationPlan.md)> |  | [optional]
