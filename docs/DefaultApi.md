...
> models::GetClusterTokenByClusterId200Response get_cluster_token_by_cluster_id(cluster_id, read_only)
...
**read_only** | Option<**bool**> | If true, returns a short-lived token for the qovery-readonly ServiceAccount (bound to view ClusterRole) generated by the cluster-agent |  |
