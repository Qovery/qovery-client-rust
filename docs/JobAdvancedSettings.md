...
**build_ephemeral_storage_in_gib** | Option<**i32**> | Ephemeral storage for the build (in GiB) | [optional]
...
**cronjob_concurrency_policy** | Option<**String**> |  | [optional]
**cronjob_failed_jobs_history_limit** | Option<**i32**> |  | [optional]
**cronjob_success_jobs_history_limit** | Option<**i32**> |  | [optional]
