...
pub struct CronJobResponse {
    ...
    pub schedule: Box<models::CronJobResponseAllOfSchedule>,
...
impl CronJobResponse {
    pub fn new(id: uuid::Uuid, created_at: String, environment: models::ReferenceObject, maximum_cpu: i32, maximum_memory: i32, name: String, cpu: i32, memory: i32, auto_preview: bool, source: models::BaseJobResponseAllOfSource, healthchecks: models::Healthcheck, icon_uri: String, service_type: models::ServiceTypeEnum, job_type: JobType, schedule: models::CronJobResponseAllOfSchedule) -> CronJobResponse {
        CronJobResponse {
            id,
            created_at,
            updated_at: None,
