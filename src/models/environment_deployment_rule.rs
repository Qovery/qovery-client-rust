...
impl EnvironmentDeploymentRule {
    pub fn new(id: uuid::Uuid, created_at: String, timezone: String, start_time: String, stop_time: String, weekdays: Vec<models::WeekdayEnum>) -> EnvironmentDeploymentRule {
