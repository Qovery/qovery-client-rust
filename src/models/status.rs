...
impl Status {
    pub fn new(id: uuid::Uuid, state: models::StateEnum, service_deployment_status: models::ServiceDeploymentStatusEnum, status_details: models::StatusDetails) -> Status {
        Status {
            id,
            state,
