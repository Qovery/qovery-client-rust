...
pub struct CronJobResponseAllOfScheduleCronjob {
...
impl CronJobResponseAllOfScheduleCronjob {
    pub fn new(timezone: String, scheduled_at: String) -> CronJobResponseAllOfScheduleCronjob {
