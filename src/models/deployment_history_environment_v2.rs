...
pub struct DeploymentHistoryEnvironmentV2 {
    ...
    pub identifier: Box<models::DeploymentHistoryEnvironmentV2Identifier>,
...
impl DeploymentHistoryEnvironmentV2 {
    pub fn new(identifier: models::DeploymentHistoryEnvironmentV2Identifier, auditing_data: models::DeploymentHistoryAuditingData, status: models::StateEnum, trigger_action: models::DeploymentHistoryTriggerAction, total_duration: String, stages: Vec<models::DeploymentHistoryStage>, action_status: models::DeploymentHistoryActionStatus) -> DeploymentHistoryEnvironmentV2 {
        DeploymentHistoryEnvironmentV2 {
