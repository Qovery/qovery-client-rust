...
impl OrganizationAnnotationsGroupCreateRequest {
    pub fn new(name: String, annotations: Vec<models::Annotation>, scopes: Vec<models::OrganizationAnnotationsGroupScopeEnum>) -> OrganizationAnnotationsGroupCreateRequest {
