...
pub async fn create_git_token(configuration: &configuration::Configuration, organization_id: &str, git_token_request: Option<models::GitTokenRequest>) -> Result<models::GitTokenResponse, Error<CreateGitTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_git_token_request = git_token_request;

    let uri_str = format!("{}/organization/{organizationId}/gitToken", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
...
pub async fn create_organization(configuration: &configuration::Configuration, organization_request: Option<models::OrganizationRequest>) -> Result<models::Organization, Error<CreateOrganizationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn delete_git_token(configuration: &configuration::Configuration, organization_id: &str, git_token_id: &str) -> Result<(), Error<DeleteGitTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_git_token_id = git_token_id;

    let uri_str = format!("{}/organization/{organizationId}/gitToken/{gitTokenId}", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), gitTokenId=crate::apis::urlencode(p_git_token_id));
...
pub async fn edit_git_token(configuration: &configuration::Configuration, organization_id: &str, git_token_id: &str, git_token_request: Option<models::GitTokenRequest>) -> Result<models::GitTokenResponse, Error<EditGitTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_git_token_id = git_token_id;
    let p_git_token_request = git_token_request;
...
pub async fn edit_organization(configuration: &configuration::Configuration, organization_id: &str, organization_edit_request: Option<models::OrganizationEditRequest>) -> Result<models::Organization, Error<EditOrganizationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
...
pub async fn get_container_registry_associated_services(configuration: &configuration::Configuration, organization_id: &str, container_registry_id: &str) -> Result<models::ContainerRegistryAssociatedServicesResponseList, Error<GetContainerRegistryAssociatedServicesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetContainerRegistryAssociatedServicesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get organization git tokens associated services
pub async fn get_git_token_associated_services(configuration: &configuration::Configuration, organization_id: &str, git_token_id: &str) -> Result<models::GitTokenAssociatedServicesResponseList, Error<GetGitTokenAssociatedServicesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_git_token_id = git_token_id;

    let uri_str = format!("{}/organization/{organizationId}/gitToken/{gitTokenId}/associatedServices", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), gitTokenId=crate::apis::urlencode(p_git_token_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetGitTokenAssociatedServicesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Get organization helm repository associated services
pub async fn get_helm_repository_associated_services(configuration: &configuration::Configuration, organization_id: &str, helm_repository_id: &str) -> Result<models::HelmRepositoryAssociatedServicesResponseList, Error<GetHelmRepositoryAssociatedServicesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_helm_repository_id = helm_repository_id;

    let uri_str = format!("{}/organization/{organizationId}/helmRepository/{helmRepositoryId}/associatedServices", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), helmRepositoryId=crate::apis::urlencode(p_helm_repository_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetHelmRepositoryAssociatedServicesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_organization_git_token(configuration: &configuration::Configuration, organization_id: &str, git_token_id: &str) -> Result<models::GitTokenResponse, Error<GetOrganizationGitTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_git_token_id = git_token_id;
...
pub async fn list_organization(configuration: &configuration::Configuration, ) -> Result<models::OrganizationResponseList, Error<ListOrganizationError>> {
...
pub async fn list_organization_available_roles(configuration: &configuration::Configuration, organization_id: &str) -> Result<models::OrganizationAvailableRoleList, Error<ListOrganizationAvailableRolesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;

    let uri_str = format!("{}/organization/{organizationId}/availableRole", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListOrganizationAvailableRolesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// List organization git tokens
pub async fn list_organization_git_tokens(configuration: &configuration::Configuration, organization_id: &str) -> Result<models::GitTokenResponseList, Error<ListOrganizationGitTokensError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
...
pub async fn list_services_by_organization_id(configuration: &configuration::Configuration, organization_id: &str, project_id: Option<&str>, environment_id: Option<&str>, cluster_id: Option<&str>) -> Result<models::ListServicesByOrganizationId200Response, Error<ListServicesByOrganizationIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    ...
    let uri_str = format!("{}/organization/{organizationId}/services", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
