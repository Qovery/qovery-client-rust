...
pub async fn check_helm_custom_domain(configuration: &configuration::Configuration, helm_id: &str) -> Result<models::CheckedCustomDomainsResponse, Error<CheckHelmCustomDomainError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_helm_id = helm_id;

    let uri_str = format!("{}/helm/{helmId}/checkCustomDomain", configuration.base_path, helmId=crate::apis::urlencode(p_helm_id));
...
pub async fn create_helm_custom_domain(configuration: &configuration::Configuration, helm_id: &str, custom_domain_request: Option<models::CustomDomainRequest>) -> Result<models::CustomDomain, Error<CreateHelmCustomDomainError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_helm_id = helm_id;
    let p_custom_domain_request = custom_domain_request;

    let uri_str = format!("{}/helm/{helmId}/customDomain", configuration.base_path, helmId=crate::apis::urlencode(p_helm_id));
...
pub async fn delete_helm_custom_domain(configuration: &configuration::Configuration, helm_id: &str, custom_domain_id: &str) -> Result<(), Error<DeleteHelmCustomDomainError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_helm_id = helm_id;
    let p_custom_domain_id = custom_domain_id;

    let uri_str = format!("{}/helm/{helmId}/customDomain/{customDomainId}", configuration.base_path, helmId=crate::apis::urlencode(p_helm_id), customDomainId=crate::apis::urlencode(p_custom_domain_id));
...
pub async fn edit_helm_custom_domain(configuration: &configuration::Configuration, helm_id: &str, custom_domain_id: &str, custom_domain_request: Option<models::CustomDomainRequest>) -> Result<models::CustomDomain, Error<EditHelmCustomDomainError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_helm_id = helm_id;
    let p_custom_domain_id = custom_domain_id;
    let p_custom_domain_request = custom_domain_request;
...
/// Get a custom domain
pub async fn get_helm_custom_domain(configuration: &configuration::Configuration, helm_id: &str, custom_domain_id: &str) -> Result<models::CustomDomain, Error<GetHelmCustomDomainError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_helm_id = helm_id;
    let p_custom_domain_id = custom_domain_id;
...
pub async fn list_helm_custom_domain(configuration: &configuration::Configuration, helm_id: &str) -> Result<models::CustomDomainResponseList, Error<ListHelmCustomDomainError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_helm_id = helm_id;
