...
pub async fn create_cluster(configuration: &configuration::Configuration, organization_id: &str, cluster_request: Option<models::ClusterRequest>) -> Result<models::Cluster, Error<CreateClusterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_request = cluster_request;

    let uri_str = format!("{}/organization/{organizationId}/cluster", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
...
pub async fn delete_cluster(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str, delete_mode: Option<models::ClusterDeleteMode>) -> Result<(), Error<DeleteClusterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;
    let p_delete_mode = delete_mode;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
...
pub async fn deploy_cluster(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str, dry_run: Option<bool>) -> Result<models::ClusterStatus, Error<DeployClusterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;
    let p_dry_run = dry_run;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}/deploy", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn edit_cluster(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str, cluster_request: Option<models::ClusterRequest>) -> Result<models::Cluster, Error<EditClusterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;
    let p_cluster_request = cluster_request;
...
pub async fn edit_cluster_advanced_settings(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str, cluster_advanced_settings: Option<models::ClusterAdvancedSettings>) -> Result<models::ClusterAdvancedSettings, Error<EditClusterAdvancedSettingsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;
    let p_cluster_advanced_settings = cluster_advanced_settings;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}/advancedSettings", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
...
pub async fn edit_cluster_kubeconfig(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str, body: Option<&str>) -> Result<(), Error<EditClusterKubeconfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;
    let p_body = body;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}/kubeconfig", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
...
pub async fn edit_routing_table(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str, cluster_routing_table_request: Option<models::ClusterRoutingTableRequest>) -> Result<models::ClusterRoutingTable, Error<EditRoutingTableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;
    let p_cluster_routing_table_request = cluster_routing_table_request;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}/routingTable", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
...
pub async fn get_cluster_advanced_settings(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str) -> Result<models::ClusterAdvancedSettings, Error<GetClusterAdvancedSettingsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;
...
pub async fn get_cluster_kubeconfig(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str, with_token_from_cli: Option<bool>) -> Result<String, Error<GetClusterKubeconfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;
...
pub async fn get_cluster_kubernetes_events(configuration: &configuration::Configuration, cluster_id: &str, from_date_time: &str, to_date_time: &str, node_name: Option<&str>, pod_name: Option<&str>) -> Result<models::GetClusterKubernetesEvents200Response, Error<GetClusterKubernetesEventsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_cluster_id = cluster_id;
    ...
    let uri_str = format!("{}/cluster/{clusterId}/events", configuration.base_path, clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_cluster_metrics(configuration: &configuration::Configuration, cluster_id: &str, endpoint: &str, query: &str, start: Option<&str>, end: Option<&str>, step: Option<&str>, time: Option<&str>, timeout: Option<&str>, dedup: Option<&str>, partial_response: Option<&str>) -> Result<models::ClusterMetricsResponse, Error<GetClusterMetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_cluster_id = cluster_id;
    ...
    let uri_str = format!("{}/cluster/{clusterId}/metrics", configuration.base_path, clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_cluster_readiness_status(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str) -> Result<models::ClusterReadinessStatus, Error<GetClusterReadinessStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}/isReady", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_cluster_status(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str) -> Result<models::ClusterStatus, Error<GetClusterStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}/status", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_default_cluster_advanced_settings(configuration: &configuration::Configuration, ) -> Result<models::ClusterAdvancedSettings, Error<GetDefaultClusterAdvancedSettingsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetDefaultClusterAdvancedSettingsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_installation_helm_values(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str) -> Result<String, Error<GetInstallationHelmValuesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}/installationHelmValues", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_organization_cloud_provider_info(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str) -> Result<models::ClusterCloudProviderInfo, Error<GetOrganizationCloudProviderInfoError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}/cloudProviderInfo", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetOrganizationCloudProviderInfoError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns a list of clusters with only their id and status.
pub async fn get_organization_cluster_status(configuration: &configuration::Configuration, organization_id: &str) -> Result<models::ClusterStatusResponseList, Error<GetOrganizationClusterStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;

    let uri_str = format!("{}/organization/{organizationId}/cluster/status", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_routing_table(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str) -> Result<models::ClusterRoutingTable, Error<GetRoutingTableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;
...
/// List Cluster Logs
pub async fn list_cluster_logs(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str) -> Result<models::ClusterLogsResponseList, Error<ListClusterLogsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}/logs", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_organization_cluster(configuration: &configuration::Configuration, organization_id: &str) -> Result<models::ClusterResponseList, Error<ListOrganizationClusterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
...
/// Lock a Cluster
pub async fn lock_cluster(configuration: &configuration::Configuration, cluster_id: &str, cluster_lock_request: Option<models::ClusterLockRequest>) -> Result<models::ClusterLock, Error<LockClusterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_cluster_id = cluster_id;
    let p_cluster_lock_request = cluster_lock_request;

    let uri_str = format!("{}/cluster/{clusterId}/lock", configuration.base_path, clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn specify_cluster_cloud_provider_info(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str, cluster_cloud_provider_info_request: Option<models::ClusterCloudProviderInfoRequest>) -> Result<models::ClusterCloudProviderInfo, Error<SpecifyClusterCloudProviderInfoError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SpecifyClusterCloudProviderInfoError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Cluster stop has been requester.
pub async fn stop_cluster(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str) -> Result<models::ClusterStatus, Error<StopClusterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}/stop", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
/// Unlock a cluster
pub async fn unlock_cluster(configuration: &configuration::Configuration, cluster_id: &str) -> Result<(), Error<UnlockClusterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_cluster_id = cluster_id;
...
pub async fn update_karpenter_private_fargate_subnet_ids(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str, cluster_karpenter_private_subnet_ids_put_request: Option<models::ClusterKarpenterPrivateSubnetIdsPutRequest>) -> Result<(), Error<UpdateKarpenterPrivateFargateSubnetIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;
    let p_cluster_karpenter_private_subnet_ids_put_request = cluster_karpenter_private_subnet_ids_put_request;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}/karpenterPrivateSubnetIds", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateKarpenterPrivateFargateSubnetIdsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// allows to upgrade a cluster to next available kubernetes version
pub async fn upgrade_cluster(configuration: &configuration::Configuration, cluster_id: &str) -> Result<models::ClusterStatus, Error<UpgradeClusterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_cluster_id = cluster_id;

    let uri_str = format!("{}/cluster/{clusterId}/upgrade", configuration.base_path, clusterId=crate::apis::urlencode(p_cluster_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
