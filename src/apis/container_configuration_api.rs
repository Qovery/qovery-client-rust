...
pub async fn edit_container_advanced_settings(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<EditContainerAdvancedSettingsError> =
...
pub async fn edit_container_network(
    configuration: &configuration::Configuration,
    container_id: &str,
...
pub async fn get_container_advanced_settings(
    configuration: &configuration::Configuration,
    container_id: &str,
