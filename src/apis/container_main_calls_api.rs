...
pub async fn delete_container(configuration: &configuration::Configuration, container_id: &str) -> Result<(), Error<DeleteContainerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_container_id = container_id;

    let uri_str = format!("{}/container/{containerId}", configuration.base_path, containerId=crate::apis::urlencode(p_container_id));
...
pub async fn edit_container(configuration: &configuration::Configuration, container_id: &str, container_request: Option<models::ContainerRequest>) -> Result<models::ContainerResponse, Error<EditContainerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_container_id = container_id;
...
pub async fn get_container(configuration: &configuration::Configuration, container_id: &str) -> Result<models::ContainerResponse, Error<GetContainerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_container_id = container_id;
...
pub async fn get_container_status(configuration: &configuration::Configuration, container_id: &str) -> Result<models::Status, Error<GetContainerStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_container_id = container_id;

    let uri_str = format!("{}/container/{containerId}/status", configuration.base_path, containerId=crate::apis::urlencode(p_container_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_container_links(configuration: &configuration::Configuration, container_id: &str) -> Result<models::LinkResponseList, Error<ListContainerLinksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_container_id = container_id;

    let uri_str = format!("{}/container/{containerId}/link", configuration.base_path, containerId=crate::apis::urlencode(p_container_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
