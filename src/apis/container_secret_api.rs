...
pub async fn create_container_secret(configuration: &configuration::Configuration, container_id: &str, secret_request: Option<models::SecretRequest>) -> Result<models::Secret, Error<CreateContainerSecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_container_id = container_id;
    let p_secret_request = secret_request;

    let uri_str = format!("{}/container/{containerId}/secret", configuration.base_path, containerId=crate::apis::urlencode(p_container_id));
...
pub async fn create_container_secret_alias(configuration: &configuration::Configuration, container_id: &str, secret_id: &str, key: Option<models::Key>) -> Result<models::Secret, Error<CreateContainerSecretAliasError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_container_id = container_id;
    let p_secret_id = secret_id;
    let p_key = key;

    let uri_str = format!("{}/container/{containerId}/secret/{secretId}/alias", configuration.base_path, containerId=crate::apis::urlencode(p_container_id), secretId=crate::apis::urlencode(p_secret_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn create_container_secret_override(configuration: &configuration::Configuration, container_id: &str, secret_id: &str, value: Option<models::Value>) -> Result<models::Secret, Error<CreateContainerSecretOverrideError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_container_id = container_id;
    let p_secret_id = secret_id;
    let p_value = value;

    let uri_str = format!("{}/container/{containerId}/secret/{secretId}/override", configuration.base_path, containerId=crate::apis::urlencode(p_container_id), secretId=crate::apis::urlencode(p_secret_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateContainerSecretOverrideError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn delete_container_secret(configuration: &configuration::Configuration, container_id: &str, secret_id: &str) -> Result<(), Error<DeleteContainerSecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_container_id = container_id;
    let p_secret_id = secret_id;

    let uri_str = format!("{}/container/{containerId}/secret/{secretId}", configuration.base_path, containerId=crate::apis::urlencode(p_container_id), secretId=crate::apis::urlencode(p_secret_id));
...
pub async fn edit_container_secret(configuration: &configuration::Configuration, container_id: &str, secret_id: &str, secret_edit_request: models::SecretEditRequest) -> Result<models::Secret, Error<EditContainerSecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_container_id = container_id;
    let p_secret_id = secret_id;
...
pub async fn list_container_secrets(configuration: &configuration::Configuration, container_id: &str) -> Result<models::SecretResponseList, Error<ListContainerSecretsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_container_id = container_id;
