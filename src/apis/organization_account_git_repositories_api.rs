...
pub async fn get_organization_bitbucket_repositories(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetOrganizationBitbucketRepositoriesError> =
...
pub async fn get_organization_bitbucket_repository_branches(
    configuration: &configuration::Configuration,
    organization_id: &str,
    name: Option<&str>,
    git_token_id: Option<&str>,
) -> Result<
    models::GitRepositoryBranchResponseList,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetOrganizationBitbucketRepositoryBranchesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn get_organization_git_provider_account(
    configuration: &configuration::Configuration,
    organization_id: &str,
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetOrganizationGitProviderAccountError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn get_organization_github_repositories(
    configuration: &configuration::Configuration,
    organization_id: &str,
    git_token_id: Option<&str>,
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetOrganizationGithubRepositoriesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn get_organization_github_repository_branches(
    configuration: &configuration::Configuration,
    organization_id: &str,
    name: Option<&str>,
    git_token_id: Option<&str>,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetOrganizationGithubRepositoryBranchesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn get_organization_gitlab_repositories(
    configuration: &configuration::Configuration,
    organization_id: &str,
    git_token_id: Option<&str>,
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetOrganizationGitlabRepositoriesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn get_organization_gitlab_repository_branches(
    configuration: &configuration::Configuration,
    organization_id: &str,
    name: Option<&str>,
    git_token_id: Option<&str>,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetOrganizationGitlabRepositoryBranchesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
