...
/// struct for typed errors of method [`uninstall_environment`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UninstallEnvironmentError {
    Status401(),
    Status403(),
    Status404(),
    Status409(),
...
/// struct for typed errors of method [`uninstall_selected_services`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UninstallSelectedServicesError {
    Status400(),
    Status401(),
    Status403(),
    Status404(),
...
pub async fn cancel_environment_deployment(
...
pub async fn clean_failed_jobs(
    configuration: &configuration::Configuration,
    environment_id: &str,
...
pub async fn deploy_all_services(
    configuration: &configuration::Configuration,
    environment_id: &str,
...
pub async fn stop_selected_services(
    configuration: &configuration::Configuration,
    environment_id: &str,
    environment_service_ids_all_request: Option<models::EnvironmentServiceIdsAllRequest>,
...
pub async fn uninstall_environment(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UninstallEnvironmentError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn uninstall_selected_services(
    configuration: &configuration::Configuration,
    environment_id: &str,
    environment_service_ids_all_request: Option<models::EnvironmentServiceIdsAllRequest>,
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UninstallSelectedServicesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
