...
pub async fn create_variable_alias(
    configuration: &configuration::Configuration,
    variable_id: &str,
...
pub async fn create_variable_override(
    configuration: &configuration::Configuration,
    variable_id: &str,
...
pub async fn import_environment_variables(
    configuration: &configuration::Configuration,
    service_id: &str,
    service_type: models::ServiceTypeForVariableEnum,
