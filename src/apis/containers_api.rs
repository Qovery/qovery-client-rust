...
pub async fn auto_deploy_container_environments(configuration: &configuration::Configuration, organization_id: &str, organization_container_auto_deploy_request: Option<models::OrganizationContainerAutoDeployRequest>) -> Result<models::Status, Error<AutoDeployContainerEnvironmentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_organization_container_auto_deploy_request = organization_container_auto_deploy_request;

    let uri_str = format!("{}/organization/{organizationId}/container/deploy", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AutoDeployContainerEnvironmentsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// This will create a new container with the same configuration on the targeted environment Id.
pub async fn clone_container(configuration: &configuration::Configuration, container_id: &str, clone_service_request: Option<models::CloneServiceRequest>) -> Result<models::ContainerResponse, Error<CloneContainerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_container_id = container_id;
    let p_clone_service_request = clone_service_request;

    let uri_str = format!("{}/container/{containerId}/clone", configuration.base_path, containerId=crate::apis::urlencode(p_container_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn create_container(configuration: &configuration::Configuration, environment_id: &str, container_request: Option<models::ContainerRequest>) -> Result<models::ContainerResponse, Error<CreateContainerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_environment_id = environment_id;
    let p_container_request = container_request;

    let uri_str = format!("{}/environment/{environmentId}/container", configuration.base_path, environmentId=crate::apis::urlencode(p_environment_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn get_container_registry_container_status(configuration: &configuration::Configuration, organization_id: &str, container_registry_id: &str) -> Result<models::ReferenceObjectStatusResponseList, Error<GetContainerRegistryContainerStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_container_registry_id = container_registry_id;

    let uri_str = format!("{}/organization/{organizationId}/containerRegistry/{containerRegistryId}/container/status", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), containerRegistryId=crate::apis::urlencode(p_container_registry_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetContainerRegistryContainerStatusError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_default_container_advanced_settings(configuration: &configuration::Configuration, ) -> Result<models::ContainerAdvancedSettings, Error<GetDefaultContainerAdvancedSettingsError>> {

    let uri_str = format!("{}/defaultContainerAdvancedSettings", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetDefaultContainerAdvancedSettingsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns a list of containers with only their id and status.
pub async fn get_environment_container_status(configuration: &configuration::Configuration, environment_id: &str) -> Result<models::ReferenceObjectStatusResponseList, Error<GetEnvironmentContainerStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_environment_id = environment_id;

    let uri_str = format!("{}/environment/{environmentId}/container/status", configuration.base_path, environmentId=crate::apis::urlencode(p_environment_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetEnvironmentContainerStatusError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn list_container(configuration: &configuration::Configuration, environment_id: &str) -> Result<models::ContainerResponseList, Error<ListContainerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_environment_id = environment_id;
...
pub async fn preview_container_environments(configuration: &configuration::Configuration, organization_id: &str, organization_container_preview_request: Option<models::OrganizationContainerPreviewRequest>) -> Result<models::Status, Error<PreviewContainerEnvironmentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_organization_container_preview_request = organization_container_preview_request;

    let uri_str = format!("{}/organization/{organizationId}/container/preview", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
