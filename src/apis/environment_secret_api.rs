...
) -> Result<models::Secret, Error<CreateEnvironmentSecretError>> {
...
pub async fn create_environment_secret_alias(
    configuration: &configuration::Configuration,
    environment_id: &str,
    secret_id: &str,
    key: Option<models::Key>,
) -> Result<models::Secret, Error<CreateEnvironmentSecretAliasError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_environment_id = environment_id;
...
pub async fn create_environment_secret_override(
    configuration: &configuration::Configuration,
    environment_id: &str,
    secret_id: &str,
    value: Option<models::Value>,
) -> Result<models::Secret, Error<CreateEnvironmentSecretOverrideError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_environment_id = environment_id;
    let p_secret_id = secret_id;
    let p_value = value;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateEnvironmentSecretOverrideError> =
...
pub async fn delete_environment_secret(
    ...
    environment_id: &str,
    secret_id: &str,
) -> Result<(), Error<DeleteEnvironmentSecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_environment_id = environment_id;
    let p_secret_id = secret_id;
...
) -> Result<models::Secret, Error<EditEnvironmentSecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_environment_id = environment_id;
    let p_secret_id = secret_id;
...
pub async fn list_environment_secrets(
    configuration: &configuration::Configuration,
    environment_id: &str,
) -> Result<models::SecretResponseList, Error<ListEnvironmentSecretsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_environment_id = environment_id;
