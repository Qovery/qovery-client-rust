...
pub async fn get_organization_event_targets(configuration: &configuration::Configuration, organization_id: &str, from_timestamp: Option<&str>, to_timestamp: Option<&str>, event_type: Option<models::OrganizationEventType>, target_type: Option<models::OrganizationEventTargetType>, triggered_by: Option<&str>, origin: Option<models::OrganizationEventOrigin>, project_id: Option<&str>, environment_id: Option<&str>) -> Result<models::OrganizationEventTargetResponseList, Error<GetOrganizationEventTargetsError>> {
    ...
    let uri_str = format!("{}/organization/{organizationId}/targets", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
...
pub async fn get_organization_events(configuration: &configuration::Configuration, organization_id: &str, page_size: Option<f64>, from_timestamp: Option<&str>, to_timestamp: Option<&str>, continue_token: Option<&str>, step_back_token: Option<&str>, event_type: Option<models::OrganizationEventType>, target_type: Option<models::OrganizationEventTargetType>, target_id: Option<&str>, sub_target_type: Option<models::OrganizationEventSubTargetType>, triggered_by: Option<&str>, origin: Option<models::OrganizationEventOrigin>) -> Result<models::OrganizationEventResponseList, Error<GetOrganizationEventsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    ...
    let uri_str = format!("{}/organization/{organizationId}/events", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
