...
pub async fn create_project_environment_variable(
...
) -> Result<models::EnvironmentVariable, Error<CreateProjectEnvironmentVariableError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateProjectEnvironmentVariableError> =
...
pub async fn create_project_environment_variable_alias(
    configuration: &configuration::Configuration,
    project_id: &str,
    environment_variable_id: &str,
    key: Option<models::Key>,
) -> Result<models::EnvironmentVariable, Error<CreateProjectEnvironmentVariableAliasError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_project_id = project_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateProjectEnvironmentVariableAliasError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn create_project_environment_variable_override(
    configuration: &configuration::Configuration,
    project_id: &str,
    environment_variable_id: &str,
    value: Option<models::Value>,
) -> Result<models::EnvironmentVariable, Error<CreateProjectEnvironmentVariableOverrideError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_project_id = project_id;
    let p_environment_variable_id = environment_variable_id;
    let p_value = value;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateProjectEnvironmentVariableOverrideError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn delete_project_environment_variable(
    configuration: &configuration::Configuration,
    project_id: &str,
    environment_variable_id: &str,
) -> Result<(), Error<DeleteProjectEnvironmentVariableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_project_id = project_id;
    let p_environment_variable_id = environment_variable_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteProjectEnvironmentVariableError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn edit_project_environment_variable(
...
) -> Result<models::EnvironmentVariable, Error<EditProjectEnvironmentVariableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_project_id = project_id;
    let p_environment_variable_id = environment_variable_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<EditProjectEnvironmentVariableError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_project_environment_variable(
    configuration: &configuration::Configuration,
    project_id: &str,
) -> Result<models::EnvironmentVariableResponseList, Error<ListProjectEnvironmentVariableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_project_id = project_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListProjectEnvironmentVariableError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
