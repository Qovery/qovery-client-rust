...
pub async fn create_job_deployment_restriction(configuration: &configuration::Configuration, job_id: &str, job_deployment_restriction_request: Option<models::JobDeploymentRestrictionRequest>) -> Result<models::JobDeploymentRestrictionResponse, Error<CreateJobDeploymentRestrictionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_job_id = job_id;
    let p_job_deployment_restriction_request = job_deployment_restriction_request;

    let uri_str = format!("{}/job/{jobId}/deploymentRestriction", configuration.base_path, jobId=crate::apis::urlencode(p_job_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateJobDeploymentRestrictionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Delete a job deployment restriction
pub async fn delete_job_deployment_restriction(configuration: &configuration::Configuration, job_id: &str, deployment_restriction_id: &str) -> Result<(), Error<DeleteJobDeploymentRestrictionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_job_id = job_id;
    let p_deployment_restriction_id = deployment_restriction_id;

    let uri_str = format!("{}/job/{jobId}/deploymentRestriction/{deploymentRestrictionId}", configuration.base_path, jobId=crate::apis::urlencode(p_job_id), deploymentRestrictionId=crate::apis::urlencode(p_deployment_restriction_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteJobDeploymentRestrictionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Edit a job deployment restriction
pub async fn edit_job_deployment_restriction(configuration: &configuration::Configuration, job_id: &str, deployment_restriction_id: &str, job_deployment_restriction_request: Option<models::JobDeploymentRestrictionRequest>) -> Result<models::JobDeploymentRestrictionResponse, Error<EditJobDeploymentRestrictionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_job_id = job_id;
    let p_deployment_restriction_id = deployment_restriction_id;
    let p_job_deployment_restriction_request = job_deployment_restriction_request;
...
pub async fn get_job_deployment_restrictions(configuration: &configuration::Configuration, job_id: &str) -> Result<models::JobDeploymentRestrictionResponseList, Error<GetJobDeploymentRestrictionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_job_id = job_id;
