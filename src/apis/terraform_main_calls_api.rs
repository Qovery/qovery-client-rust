...
pub async fn delete_terraform(configuration: &configuration::Configuration, terraform_id: &str) -> Result<(), Error<DeleteTerraformError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_terraform_id = terraform_id;

    let uri_str = format!("{}/terraform/{terraformId}", configuration.base_path, terraformId=crate::apis::urlencode(p_terraform_id));
...
pub async fn edit_terraform(configuration: &configuration::Configuration, terraform_id: &str, terraform_request: Option<models::TerraformRequest>) -> Result<models::TerraformResponse, Error<EditTerraformError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_terraform_id = terraform_id;
...
pub async fn get_terraform(configuration: &configuration::Configuration, terraform_id: &str) -> Result<models::TerraformResponse, Error<GetTerraformError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_terraform_id = terraform_id;
