...
pub async fn edit_job(configuration: &configuration::Configuration, job_id: &str, job_request: Option<models::JobRequest>) -> Result<models::JobResponse, Error<EditJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_job_id = job_id;
...
pub async fn get_job_status(configuration: &configuration::Configuration, job_id: &str) -> Result<models::Status, Error<GetJobStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_job_id = job_id;

    let uri_str = format!("{}/job/{jobId}/status", configuration.base_path, jobId=crate::apis::urlencode(p_job_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_job_commit(configuration: &configuration::Configuration, job_id: &str, start_id: Option<&str>, git_commit_id: Option<&str>) -> Result<models::CommitResponseList, Error<ListJobCommitError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_job_id = job_id;
    let p_start_id = start_id;
    let p_git_commit_id = git_commit_id;

    let uri_str = format!("{}/job/{jobId}/commit", configuration.base_path, jobId=crate::apis::urlencode(p_job_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
