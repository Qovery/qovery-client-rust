...
pub async fn add_credit_card(configuration: &configuration::Configuration, organization_id: &str, credit_card_request: Option<models::CreditCardRequest>) -> Result<models::CreditCard, Error<AddCreditCardError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_credit_card_request = credit_card_request;

    let uri_str = format!("{}/organization/{organizationId}/creditCard", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
...
pub async fn add_credit_code(configuration: &configuration::Configuration, organization_id: &str, organization_credit_code_request: Option<models::OrganizationCreditCodeRequest>) -> Result<(), Error<AddCreditCodeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_organization_credit_code_request = organization_credit_code_request;

    let uri_str = format!("{}/organization/{organizationId}/creditCode", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn change_plan(configuration: &configuration::Configuration, organization_id: &str, organization_change_plan_request: Option<models::OrganizationChangePlanRequest>) -> Result<models::Organization, Error<ChangePlanError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_organization_change_plan_request = organization_change_plan_request;

    let uri_str = format!("{}/organization/{organizationId}/changePlan", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn delete_credit_card(configuration: &configuration::Configuration, organization_id: &str, credit_card_id: &str) -> Result<(), Error<DeleteCreditCardError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_credit_card_id = credit_card_id;

    let uri_str = format!("{}/organization/{organizationId}/creditCard/{creditCardId}", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), creditCardId=crate::apis::urlencode(p_credit_card_id));
...
pub async fn edit_organization_billing_info(configuration: &configuration::Configuration, organization_id: &str, billing_info_request: Option<models::BillingInfoRequest>) -> Result<models::BillingInfo, Error<EditOrganizationBillingInfoError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_billing_info_request = billing_info_request;

    let uri_str = format!("{}/organization/{organizationId}/billingInfo", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
...
pub async fn generate_billing_usage_report(configuration: &configuration::Configuration, organization_id: &str, organization_billing_usage_report_request: Option<models::OrganizationBillingUsageReportRequest>) -> Result<models::OrganizationBillingUsageReportResponse, Error<GenerateBillingUsageReportError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_organization_billing_usage_report_request = organization_billing_usage_report_request;

    let uri_str = format!("{}/organization/{organizationId}/billingUsageReport", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn get_cluster_current_cost(configuration: &configuration::Configuration, organization_id: &str, cluster_id: &str) -> Result<models::CostRange, Error<GetClusterCurrentCostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_cluster_id = cluster_id;

    let uri_str = format!("{}/organization/{organizationId}/cluster/{clusterId}/currentCost", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), clusterId=crate::apis::urlencode(p_cluster_id));
...
pub async fn get_organization_billing_external_id(configuration: &configuration::Configuration, organization_id: &str) -> Result<models::BillingExternalId, Error<GetOrganizationBillingExternalIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;

    let uri_str = format!("{}/organization/{organizationId}/billingExternalId", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetOrganizationBillingExternalIdError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub async fn get_organization_billing_info(configuration: &configuration::Configuration, organization_id: &str) -> Result<models::BillingInfo, Error<GetOrganizationBillingInfoError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
...
pub async fn get_organization_billing_status(configuration: &configuration::Configuration, organization_id: &str) -> Result<models::BillingStatus, Error<GetOrganizationBillingStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;

    let uri_str = format!("{}/organization/{organizationId}/billingStatus", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_organization_current_cost(configuration: &configuration::Configuration, organization_id: &str) -> Result<models::OrganizationCurrentCost, Error<GetOrganizationCurrentCostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;

    let uri_str = format!("{}/organization/{organizationId}/currentCost", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_organization_invoice(configuration: &configuration::Configuration, organization_id: &str, invoice_id: &str) -> Result<models::Invoice, Error<GetOrganizationInvoiceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_invoice_id = invoice_id;

    let uri_str = format!("{}/organization/{organizationId}/invoice/{invoiceId}", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), invoiceId=crate::apis::urlencode(p_invoice_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_organization_invoice_pdf(configuration: &configuration::Configuration, organization_id: &str, invoice_id: &str) -> Result<models::Link, Error<GetOrganizationInvoicePdfError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
    let p_invoice_id = invoice_id;

    let uri_str = format!("{}/organization/{organizationId}/invoice/{invoiceId}/download", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id), invoiceId=crate::apis::urlencode(p_invoice_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_organization_credit_cards(configuration: &configuration::Configuration, organization_id: &str) -> Result<models::CreditCardResponseList, Error<ListOrganizationCreditCardsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;
...
pub async fn list_organization_invoice(configuration: &configuration::Configuration, organization_id: &str) -> Result<models::InvoiceResponseList, Error<ListOrganizationInvoiceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;

    let uri_str = format!("{}/organization/{organizationId}/invoice", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn organization_download_all_invoices(configuration: &configuration::Configuration, organization_id: &str) -> Result<(), Error<OrganizationDownloadAllInvoicesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_organization_id = organization_id;

    let uri_str = format!("{}/organization/{organizationId}/downloadInvoices", configuration.base_path, organizationId=crate::apis::urlencode(p_organization_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OrganizationDownloadAllInvoicesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
