...
pub async fn delete_invite_member(
...
pub async fn edit_organization_member_role(
    configuration: &configuration::Configuration,
    organization_id: &str,
...
pub async fn get_member_invitation(
    configuration: &configuration::Configuration,
    organization_id: &str,
    invite_id: &str,
...
pub async fn get_organization_invited_members(
    configuration: &configuration::Configuration,
    organization_id: &str,
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetOrganizationInvitedMembersError> =
...
pub async fn post_accept_invite_member(
    configuration: &configuration::Configuration,
    organization_id: &str,
    invite_id: &str,
...
pub async fn post_invite_member(
    configuration: &configuration::Configuration,
    organization_id: &str,
...
pub async fn post_organization_transfer_ownership(
    configuration: &configuration::Configuration,
    organization_id: &str,
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostOrganizationTransferOwnershipError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
