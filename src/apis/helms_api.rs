...
pub async fn clone_helm(configuration: &configuration::Configuration, helm_id: &str, clone_service_request: Option<models::CloneServiceRequest>) -> Result<models::HelmResponse, Error<CloneHelmError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_helm_id = helm_id;
    let p_clone_service_request = clone_service_request;

    let uri_str = format!("{}/helm/{helmId}/clone", configuration.base_path, helmId=crate::apis::urlencode(p_helm_id));
...
pub async fn create_helm(configuration: &configuration::Configuration, environment_id: &str, helm_request: Option<models::HelmRequest>) -> Result<models::HelmResponse, Error<CreateHelmError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_environment_id = environment_id;
    let p_helm_request = helm_request;

    let uri_str = format!("{}/environment/{environmentId}/helm", configuration.base_path, environmentId=crate::apis::urlencode(p_environment_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn create_helm_default_values(configuration: &configuration::Configuration, environment_id: &str, helm_default_values_request: Option<models::HelmDefaultValuesRequest>) -> Result<String, Error<CreateHelmDefaultValuesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_environment_id = environment_id;
    let p_helm_default_values_request = helm_default_values_request;

    let uri_str = format!("{}/environment/{environmentId}/helmDefaultValues", configuration.base_path, environmentId=crate::apis::urlencode(p_environment_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn get_default_helm_advanced_settings(configuration: &configuration::Configuration, ) -> Result<models::HelmAdvancedSettings, Error<GetDefaultHelmAdvancedSettingsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetDefaultHelmAdvancedSettingsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns a list of helms with only their id and status.
pub async fn get_environment_helm_status(configuration: &configuration::Configuration, environment_id: &str) -> Result<models::ReferenceObjectStatusResponseList, Error<GetEnvironmentHelmStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_environment_id = environment_id;

    let uri_str = format!("{}/environment/{environmentId}/helm/status", configuration.base_path, environmentId=crate::apis::urlencode(p_environment_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_helms(configuration: &configuration::Configuration, environment_id: &str) -> Result<models::HelmResponseList, Error<ListHelmsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_environment_id = environment_id;
