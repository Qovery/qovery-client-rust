...
*SecretManagerAccessApi* | [**list_secret_manager_access_external_secrets**](docs/SecretManagerAccessApi.md#list_secret_manager_access_external_secrets) | **GET** /api/secretManagerAccess/{secretManagerAccessId}/associatedServices | List external secrets used by a secret manager access
*SecretManagerAccessApi* | [**list_upstream_secrets_from_secret_provider**](docs/SecretManagerAccessApi.md#list_upstream_secrets_from_secret_provider) | **GET** /api/secretManagerAccess/{secretManagerAccessId}/secrets | List upstream secrets from secret provider
